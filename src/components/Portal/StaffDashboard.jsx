        ...
        <div className="portal-section-head">
          <div>
            ...
            <p className="portal-section-copy" style={{ color: 'rgba(255,255,255,0.76)' }}>
              Today is {formatPortalPrettyDate()}. Keep check-ins, visits, reports, and orders moving from one mobile workspace.
            </p>
          </div>
        </div>
        ...
        <div className="portal-section-head">
          <div>
            ...
            <p className="portal-section-copy">
              Begin with attendance, then log visits and submit reports or orders before the day ends. Use the buttons below for the most common actions.
            </p>
          </div>
        </div>
      </div>
