...
const staticRoutes = [
  ...
  { path: '/categories/ppe-gloves', changefreq: 'weekly', priority: '0.85' },
  { path: '/categories/ppe-masks-shields', changefreq: 'weekly', priority: '0.82' },
  { path: '/categories/examination-general-disposable', changefreq: 'weekly', priority: '0.82' },
